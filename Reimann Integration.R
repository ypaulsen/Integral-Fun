...
# The following program uses Reimann integration to calculate the area under the
...
# This program performs a Reimann integration on the function defined as f() 
...
# Function  
f <- function(x) dnorm(x)                     # Input function to analize
